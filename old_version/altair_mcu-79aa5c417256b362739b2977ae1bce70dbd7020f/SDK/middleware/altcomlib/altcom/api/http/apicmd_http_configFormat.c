...
/**
 @brief altcom_http_format_config() IP configuration.
...
Http_err_code_e altcom_http_format_config(Http_profile_id_e profile_id,
  ...
  if (http_format_config->respHeaderPresent > RESP_HEADER_PRESENCE_ENABLE) {
  ...
  if (http_format_config->reqHeaderPresent > REQ_HEADER_PRESENCE_ENABLE) {
