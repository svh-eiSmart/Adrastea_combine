 ...
 *
 * @param handle Task handle that the flag is sending to
 * @param flags Flags to be sent to a task
 ...
 *
 * @param flags Flags to be waiting for
 * @param options Possible value are ALT_OSAL_WMODE_TWF_ORW, ALT_OSAL_WMODE_TWF_ANDW and
 * ALT_OSAL_FLAG_NO_CLEAR
 * @param timeout Specify the timeout value on waiting flags
 ...
 *
 * @param flags Specify the flags that shall be cleared
 ...
 * @brief Exit critical section
 *
 * @param status Specify the flags that shall be cleared
 *
