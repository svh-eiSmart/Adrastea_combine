...
#define PWR_MNGR_MAX_STOP_DRUATION         \
  (60000) /**< The maximum stop sleep duration 
(usigned integer and in unit of mSec). The value(0) means no duration adjustment. 
This value may be adjusted per project. */
...
/**
 * @brief Definition of the counters to record how many times RTOS was prevented to go to low power mode.
 */
typedef struct {
 ...
 * @return None.
 */
void pwr_mngr_post_sleep_process(uint32_t idle_time);
