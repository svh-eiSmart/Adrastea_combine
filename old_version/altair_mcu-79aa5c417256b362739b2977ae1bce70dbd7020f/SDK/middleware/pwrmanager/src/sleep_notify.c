...
typedef struct alt_Node {
  /*Function pointer*/
  int32_t (*pCallback)(sleep_notify_state, void*);
...
*/
int32_t sleep_notify_register_callback(int32_t (*P_Callback)(sleep_notify_state, void*),
...
SLEEP_NOTIFY_ERROR - get invalid arguments.
*/
int32_t sleep_notify(sleep_notify_state sleep_state) {
  sleepNode* newsleepNode = NULL;
