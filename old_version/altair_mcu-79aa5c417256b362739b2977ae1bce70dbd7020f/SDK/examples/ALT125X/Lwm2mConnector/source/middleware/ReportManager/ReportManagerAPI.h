...
typedef struct {
  ...
  int Timestamp;  // Unix Time. A signed integer representing the number of seconds since Jan 1st,
...
typedef int (*reportManagerReadIndCB_t)(int objectId, int instanceNum, int resourceNum,
                                        int *resourceInst, LWM2MRsrc_type_e *valType,
                                        LWM2MInstnc_type_e *instType, resourceVal_t *resourceVal,
                                        void *userPriv);
