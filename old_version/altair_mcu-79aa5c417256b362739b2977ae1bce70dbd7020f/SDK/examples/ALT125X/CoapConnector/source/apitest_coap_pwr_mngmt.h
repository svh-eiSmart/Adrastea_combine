...
/*Command line callback executed a warm boot */
typedef void (*command_handler_t)(char *s);

void save_conf_param_to_gpm(void);

/****************************************************************************
 * Global Data
 ****************************************************************************/
static uint8_t Send_status = (uint8_t)0;
static char urc_recv_payload[DATA_LEN] = {0};
unsigned int CurrentTime, resume_session = 0;
