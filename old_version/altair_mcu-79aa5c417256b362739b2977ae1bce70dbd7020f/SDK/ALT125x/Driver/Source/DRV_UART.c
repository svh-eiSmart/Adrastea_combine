...
void DRV_UART_Enable_Break_Interrupt(UART_Type *base) { DRV_UART_Enable_Interrupt(base, BREAK_ERROR); }
void DRV_UART_Disable_Break_Interrupt(UART_Type *base) { DRV_UART_Disable_Interrupt(base, BREAK_ERROR); }
